...
export type EngineConfigurationMetric = 'arcade' | 'arcadePercentage' | 'accuracy' | 'accuracyPercentage' | 'life' | 'time' | 'perfect' | 'perfectPercentage' | 'greatGoodMiss' | 'greatGoodMissPercentage' | 'miss' | 'missPercentage' | 'errorHeatmap';
